...
class _ZakatCalculatorState extends State<ZakatCalculator> {
  ...
  final TextEditingController investmentPropertyController = TextEditingController();
              ...
              GestureDetector(
                onTap: (){
                  if(selectedCurrency != null){
                    ...
                    FunctionsAndMethods.showSnackbarErrorMessage("enter_a_currency".tr);
                  }
                },
                child: Container(
                  height: 55.h,
  ...
  Widget countryDropdownWidget() {
    ...
    List<String> fieldNames = provider.allCurrency != null
        ? getFieldNames()
        : [];
    ...
    return DropdownButtonFormField<String>(
      ...
      items: fieldNames.map<DropdownMenuItem<String>>(
          ...
          return DropdownMenuItem<String>(
            ...
            child: Text(
              fieldName,
              style: TextStyle(fontSize: 14, color: AppColors.colorAlert),
            ),
          );
        },
      ).toList(),
  ...
  void calculate() {
    ...
    setState(() {
      ...
      final double amt_assets_gross = amt_home + amt_bank + amt_shares + amt_merchandise + amt_gold + amt_property + amt_other;
